...
Since this ARO cluster version is old, we need to manually update the kata rpm package inside the worker node. Unfortunately this is a limitation of this workshop.

If you are running this in a newer ARO cluser, you don't have to worry about this.
